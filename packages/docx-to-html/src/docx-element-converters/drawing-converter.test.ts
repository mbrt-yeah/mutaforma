...
describe(`${DrawingConverter.name}`, () => {
    ...
    describe("#execute", () => {
        it(`should convert w:drawing element representing a referenced image to ${CoImage.name} node`, async () => {
            const $elem = cheerio.load(`<w:drawing><wp:inline distT="0" distB="0" distL="0" distR="0" wp14:anchorId="583A8BC7" wp14:editId="072A003B"><wp:extent cx="4467225" cy="3219450" /><wp:effectExtent l="0" t="0" r="9525" b="0" /><wp:docPr id="792775376" name="Screenshot 2024-06-17 094104.png" descr="Alt text figure 2" /><wp:cNvGraphicFramePr><a:graphicFrameLocks xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" noChangeAspect="1" /></wp:cNvGraphicFramePr><a:graphic xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main"><a:graphicData uri="http://schemas.openxmlformats.org/drawingml/2006/picture"><pic:pic xmlns:pic="http://schemas.openxmlformats.org/drawingml/2006/picture"><pic:nvPicPr><pic:cNvPr id="792775376" name="Screenshot 2024-06-17 094104.png" descr="Alt text figure 2" /><pic:cNvPicPr /></pic:nvPicPr><pic:blipFill><a:blip r:link="rId9" /><a:stretch><a:fillRect /></a:stretch></pic:blipFill><pic:spPr><a:xfrm><a:off x="0" y="0" /><a:ext cx="4467225" cy="3219450" /></a:xfrm><a:prstGeom prst="rect"><a:avLst /></a:prstGeom></pic:spPr></pic:pic></a:graphicData></a:graphic></wp:inline></w:drawing>`, null, false);
            const instance = new DrawingConverter(config, docxFile, registry);
            const executionResult = await instance.execute($elem);
